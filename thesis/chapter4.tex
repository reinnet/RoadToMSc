...
\section{اهمیت مساله}
مساله‌ی حاضر جایگذاری منابع مدیریتی را در کنار جایگذاری زنجیره‌ها به صورت توامان انجام می‌دهد.
از آنجایی که برای منابع مدیریتی هزینه‌ای مدنظر است نمی‌توان آن‌ها را به عنوان بخشی از زنجیره‌ها جایگذاری کرد چرا که نیاز است اشتراک بین آن‌ها در جهت کاهش هزینه‌ها صورت بگیرد.

مساله‌ی دیگر حل توامان است، با حل توامان می‌توان محدودیت‌های مدیریتی مشخصی تعریف نمود که در صورتی که مساله به صورت جداگانه (در دو مرحله جایگذاری زنجیره‌ها و منابع مدیریتی) حل شود توان اعمال آن‌ها وجود ندارد.
...
در زمان جایگذاری منابع مدیریتی برای جلوگیری از ناممکن نشدن مساله مجبور به در نظر نگرفتن
تعدادی از زنجیره‌های انتخاب شده در مرحله قبل می‌شود که به این ترتیب سود کاهش پیدا می‌کند.

مساله‌ی توامان حتی بدون در نظر گرفتن محدودیت‌های مدیریتی و تنها با در نظر گرفتن نیاز منابع مدیریتی به پردازش و حافظه باز هم می‌تواند سود بیشتری بدست آورد.
اگر فرض کنید زیرساخت گنجایش منابع مدیریتی و زنجیره‌ها به صورت همزمان را دارد، نمودار \ref{fig.21} سود حاصل از پذیرش زنجیره‌ها را نمایش می‌دهد.
...
در نظر داشته باشید که برای جلوگیری از غیرممکن شدن مساله‌ی غیرتوامان به مرحله‌ی دوم اجازه داده می‌شود که از بین زنجیره‌های پذیرفته شده در گام اول تعدادی را نپذیرد.
نکته‌ی مهم در مساله‌ی غیرتوامان در اولین مرحله‌ی آن می‌باشد که ممکن است تعداد زیادی زنجیره را پذیرفته و
به این ترتیب کار را در مرحله‌ی دوم پیچیده کرده و باعث رد شدن تعداد زیادی از زنجیره‌های انتخاب شده گردد.
