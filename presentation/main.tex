...
\begin{frame}{\lr{VNFM}}
    \begin{itemize}\RTList{}
        ...
        \begin{itemize}\RTList{}
            ...
            \item نگاشت \lr{VNFM}ها به نمونه‌ها با توجه به تعداد بالای آن‌ها
        \end{itemize}
    \end{itemize}
\end{frame}
%-------------------------------------------------------------------------------
...
\begin{frame}{پژوهش حاضر}
    \begin{itemize}\RTList{}
        ...
        \item در نظر گرفتن هزینه‌ی گواهی \lr{VNFM}ها
...
\begin{frame}{\lr{eJSD-MP}}
    \begin{itemize}\RTList{}
        \justifying
        \item الگوریتم پیشنهادی \lr{JSD-MP} از برون‌خط بودن مساله استفاده نمی‌کند.
        ...
        \item برای کاهش زمان اجرای الگوریتم نسبت مشخصی از زنجیره‌ها را با الگوریتم \lr{first-fit} جایگذاری می‌کنیم.
...
\begin{frame}{جمع‌بندی}
    \begin{itemize}\RTList{}
        ...
        \item الگوریتم \lr{eJSD-MP} در زمان کمتر نتایجی بهتر یا برابر با الگوریتم \lr{JSD-MP} ارائه می‌کند.
    \end{itemize}
\end{frame}
%-------------------------------------------------------------------------------
\begin{frame}{کارهای آینده}
    \begin{itemize}\RTList{}
        \item در نظر گرفتن نگاشت سایر منابع مدیریتی مانند \lr{EM} و \lr{VNMFO}
...
\begin{frame}[shrink=25]{مراجع}
    \begin{latin}
    \begin{itemize}
        \item \cite{Bari2015} \fullcite{Bari2015}
        \item \cite{Eramo2016} \fullcite{Eramo2016}
        \item \cite{Ghaznavi2017} \fullcite{Ghaznavi2017}
        \item \cite{AbuLebdeh2017} \fullcite{AbuLebdeh2017}
        \item \cite{Huang2017} \fullcite{Huang2017}
    \end{itemize}
    \end{latin}
\end{frame}
%-------------------------------------------------------------------------------
...
\begin{frame}{ارزیابی}
    \begin{table}[h]
        \caption{سود نهایی الگوریتم‌های بهینه، \lr{eJSD-MP} و \lr{JSD-MP} برای توپولوژی \lr{FatTree}}
        \vspace{0.5cm}
...
\begin{frame}{ارزیابی}
    \begin{table}[h]
        \caption{سود نهایی الگوریتم‌های بهینه، \lr{eJSD-MP} و \lr{JSD-MP} برای توپولوژی \lr{USnet}}
        \vspace{0.5cm}
        \begin{tabularx}{\textwidth}{ccccccccc}
            \toprule
            تعداد زنجیره‌ها &
